...
import br.dev.allissonnunes.algashop.ordering.core.application.customer.CustomerManagementApplicationService;
import br.dev.allissonnunes.algashop.ordering.core.application.customer.CustomerOutputTestDataBuilder;
import br.dev.allissonnunes.algashop.ordering.core.application.customer.CustomerSummaryOutputTestDataBuilder;
...
import br.dev.allissonnunes.algashop.ordering.core.ports.in.customer.CustomerInput;
...
class CustomerControllerContractTest {
    ...
    void registerCustomerContract() {
        ...
        when(forQueryingCustomers.findById(Mockito.any(UUID.class)))
    ...
    void getAllCustomersContract() {
        ...
        when(forQueryingCustomers.filter(Mockito.any(CustomerFilter.class)))
