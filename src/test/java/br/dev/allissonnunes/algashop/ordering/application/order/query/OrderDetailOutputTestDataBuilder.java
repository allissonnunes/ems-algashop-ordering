...
public class OrderDetailOutputTestDataBuilder {
    ...
    public static OrderDetailOutput.OrderDetailOutputBuilder placedOrder(final String orderId) {
    ...
    private static List<OrderItemDetailOutput> itemsOutput(final String orderId) {
        final List<OrderItemDetailOutput> items = new ArrayList<>();
