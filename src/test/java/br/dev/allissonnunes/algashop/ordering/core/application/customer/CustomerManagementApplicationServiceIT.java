...
import br.dev.allissonnunes.algashop.ordering.core.domain.model.customer.*;
...
import br.dev.allissonnunes.algashop.ordering.infrastructure.adapters.in.listener.CustomerEventListener;
...
class CustomerManagementApplicationServiceIT extends AbstractApplicationIT {
    ...
    void shouldCreate() {
        ...
        final CustomerOutput customerOutput = forQueryingCustomers.findById(customerId);
