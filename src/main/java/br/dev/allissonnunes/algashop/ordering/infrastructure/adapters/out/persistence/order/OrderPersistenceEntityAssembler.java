package br.dev.allissonnunes.algashop.ordering.infrastructure.adapters.out.persistence.order;

import br.dev.allissonnunes.algashop.ordering.core.domain.model.commons.Address;
import br.dev.allissonnunes.algashop.ordering.core.domain.model.order.*;
import br.dev.allissonnunes.algashop.ordering.infrastructure.adapters.out.persistence.commons.AddressEmbeddable;
import br.dev.allissonnunes.algashop.ordering.infrastructure.adapters.out.persistence.commons.DomainVersionHandler;
import br.dev.allissonnunes.algashop.ordering.infrastructure.adapters.out.persistence.customer.CustomerPersistenceEntity;
